export const positions = {
    ...
    // //B773 4 class ULR
    912: {PUR: {only: ["PUR"]}, CSV: {only: ["L5", "R2A"]}, FG1: {galley: ["L1"], df: ["R1"], remain: ["l1A"] /* Seated at R5C? */ }, GR1: {galley: ["L2A"], df: ["L2"], remain: ["R2"]}, W: {galley: ["L3"], df: ["R3"], remain: []}, GR2: {galley: ["R5"], df: ["R5A"], remain: ["L4", "R4", "L5A"]}, EXTRA: {only: []}},
    // //A350
    13: {PUR: {only: ["PUR"]}, CSV: {only: ["L4"]}, GR1: {galley: ["L1"], df: ["R1"], remain: ["L1A"]}, W: {galley: [], df: [], remain: []}, GR2: {galley: [], df: [], remain: []}, EXTRA: {only: []}}
};

//U2 do inboard seats, U3 do window seats

// 98 -> 901,  99 -> 908, 97 -> 912, 