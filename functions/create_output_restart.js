...
export function restart(event) {
    ...
    let thisTripBreaks = JSON.parse(localStorage.getItem("thisTripBreaks"));
    ...
    if (doPositions) generatePositions(crewData, thisTripPositions, thisTripBreaks, registration, numberOfDuties, hasBreak);
