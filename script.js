...
function generateTripsTable() {
  Object.keys(dataPool).forEach((item, index) => {
    ...
    let registration = description = crc = typeOfOperation = "";
    ...
    output += `<td id="VCM${index}">${vcm - crewNumber === 0 ? "" : (vcm - crewNumber) * -1 < 0 ? (vcm - crewNumber) * -1 : "+" + (vcm - crewNumber) * -1}</td>`;
